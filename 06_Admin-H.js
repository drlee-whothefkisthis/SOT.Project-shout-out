...
<style id="sot-admin-ui-fit-v2-force">
  ...
  .prh-shell{display:grid;gap:18px;max-width:1280px;margin:0 auto}.prh-shell .fr-hero{padding:24px 26px;border-radius:28px}.prh-shell .ctdash-section-head{margin-bottom:20px}.prh-shell .ctdash-section h3{font-size:27px;letter-spacing:-.045em}.prh-shell .ctdash-section p{font-size:13px;line-height:1.6}.prh-toolbar{display:flex;align-items:end;justify-content:space-between;gap:16px;flex-wrap:wrap}.prh-toolbar label{display:grid;gap:7px;min-width:min(100%,560px);color:#776f68;font-size:12px;font-weight:800}.prh-toolbar .ctdash-select{min-height:42px;font-size:13px}.prh-filters{display:flex;gap:8px;flex-wrap:wrap}.prh-filters button{border:1px solid #e7ded4;border-radius:999px;background:#fffdfa;color:#766c63;padding:9px 13px;font-size:11px;font-weight:800;cursor:pointer}.prh-filters button.is-active{border-color:#168784;background:#168784;color:#fff}.prh-layout{display:grid;grid-template-columns:360px minmax(0,1fr);gap:18px}.prh-list{padding:9px;overflow:hidden;border-radius:26px}.prh-list-head{display:flex;justify-content:space-between;gap:8px;padding:14px 14px 16px;color:#564c45;font-size:14px}.prh-list-head span{color:#8b8178;font-size:11px}.prh-list-item{display:flex;width:100%;align-items:center;justify-content:space-between;gap:11px;border:0;border-radius:15px;background:transparent;padding:15px;text-align:left;color:#453c35;cursor:pointer}.prh-list-item:hover{background:#fbf6f0}.prh-list-item.is-active{background:#eaf7f4;box-shadow:inset 0 0 0 1px rgba(22,135,132,.16)}.prh-list-item b,.prh-list-item span,.prh-list-item small{display:block}.prh-list-item b{font-size:14px}.prh-list-item span{max-width:202px;margin-top:5px;overflow:hidden;color:#81776e;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.prh-list-item>div:last-child{text-align:right}.prh-list-item small{margin-top:6px;color:#81776e;font-size:11px}.prh-detail{min-height:710px;overflow:hidden;border-radius:26px}.prh-empty{display:grid;min-height:650px;place-items:center;padding:30px;color:#80756b;font-size:13px;text-align:center}.prh-detail-head{display:flex;justify-content:space-between;gap:18px;padding:25px 27px;border-bottom:1px solid #ece4da;background:linear-gradient(90deg,#fffaf5,#eff9f7)}.prh-detail-head h3{margin:6px 0;color:#2f2925;font-size:22px;letter-spacing:-.04em}.prh-detail-head p{margin:0;color:#7e746b;font-size:13px}.prh-detail-head>div:last-child{text-align:right}.prh-detail-head small{display:block;margin-top:9px;color:#867b71;font-size:10px}.prh-status{display:inline-flex;border-radius:999px;padding:6px 9px;font-size:10px;font-style:normal;font-weight:850;white-space:nowrap}.prh-status.good{background:#e6f4f1;color:#11716e}.prh-status.issue{background:#fff0ed;color:#bd4b45}.prh-status.pending{background:#fff7df;color:#996e1a}.prh-detail-body{display:grid;gap:21px;padding:24px 27px 31px}.prh-metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.prh-metrics>div{min-height:98px;padding:15px;border:1px solid #ebe3d9;border-radius:15px;background:#fffdfa}.prh-metrics span{display:block;color:#847970;font-size:11px;font-weight:800}.prh-metrics b{display:block;margin-top:10px;color:#352d28;font-size:18px;letter-spacing:-.035em}.prh-grid{display:grid;grid-template-columns:1.1fr .9fr;gap:14px}.prh-detail h4{margin:0 0 9px;color:#5a4e45;font-size:13px}.prh-panel{padding:15px;border:1px solid #ebe3d9;border-radius:16px;background:#fffdfa}.prh-row{display:grid;grid-template-columns:78px 1fr auto;gap:9px;align-items:center;padding:10px 0;border-bottom:1px dashed #e7dfd6;font-size:13px}.prh-row:last-child{border-bottom:0}.prh-row span,.prh-row small{color:#83786e;font-size:11px;font-weight:700}.prh-row b{font-size:13px}.prh-equipment{display:flex;flex-wrap:wrap;gap:8px}.prh-equipment span{padding:8px 10px;border:1px solid #e8dfd5;border-radius:10px;background:#fffdfa;color:#584d45;font-size:11px;font-weight:750}.prh-issue{padding:15px 16px;border-radius:15px;background:#fff0ed;color:#763c37}.prh-issue b{display:block;font-size:12px}.prh-issue p{margin:5px 0 11px;font-size:12px;line-height:1.5}.prh-issue p:last-child{margin-bottom:0}.prh-feedback{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.prh-feedback>div{min-height:78px;padding:11px 12px;border:1px solid #ebe3d9;border-radius:13px;background:#fffdfa}.prh-feedback span{display:block;color:#887e75;font-size:10px;font-weight:850}.prh-feedback p{margin:6px 0 0;color:#5d524a;font-size:11px;line-height:1.45}.sh-admin-wrap.shell:has(.prh-shell){width:min(1280px,calc(100vw - 40px));max-width:none}@media(max-width:850px){.prh-layout{grid-template-columns:1fr}.prh-list{max-height:330px;overflow:auto}.prh-metrics{grid-template-columns:1fr 1fr}.prh-grid{grid-template-columns:1fr}.prh-feedback{grid-template-columns:1fr}.prh-detail{min-height:0}.sh-admin-wrap.shell:has(.prh-shell){width:calc(100vw - 24px)}}@media(max-width:560px){.prh-shell .fr-hero,.prh-detail-head,.prh-detail-body{padding-left:16px;padding-right:16px}.prh-detail-head{flex-direction:column}.prh-detail-head>div:last-child{text-align:left}.prh-metrics{grid-template-columns:1fr 1fr}.prh-toolbar label{min-width:100%}.sh-admin-wrap.shell:has(.prh-shell){width:calc(100vw - 16px)}}
</style>
